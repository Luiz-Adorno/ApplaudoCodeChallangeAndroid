...
class PopularMovieRemoteMediator(private val movieApi: MovieDbApi, private val movieDB: MovieDB) :
    RemoteMediator<Int, PopularMoviesCache>() {

    private val movieDao = movieDB.movieDao()
    private val movieRemoteKeysDao = movieDB.movieRemoteKeysDao()

    override suspend fun load(loadType: LoadType, state: PagingState<Int, PopularMoviesCache>): MediatorResult {
        return try {
            ...
            if (response.isSuccessful) {
                ...
                responseData?.let {
                    movieDB.withTransaction {
                        ...
                        movieDao.addPopularMovies(responseData.results)
                    }
                }
    ...
    private suspend fun getRemoteKeyClosestToCurrentPosition(
        state: PagingState<Int, PopularMoviesCache>,
    ): MovieRemoteKeys? {
