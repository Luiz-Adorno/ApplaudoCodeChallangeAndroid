package com.example.applaudo.presentation.screens.tv_show_details.airing_today
...
@Composable
fun AiringTodayMovieDetailsScreen(
    movieId: String,
    navController: NavController,
    viewModel: AiringTodayDetailsViewModel = hiltViewModel(),
) {
        ...
        toolbar = {
            ...
            Image(
                painter = rememberImagePainter(
                    data = Constants.POSTER_URL + movieDetails?.poster_path, builder = {
                        crossfade(true)
                        scale(Scale.FIT)
                    }),
