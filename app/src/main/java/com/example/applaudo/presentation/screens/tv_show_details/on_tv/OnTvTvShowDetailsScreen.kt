...
@Composable
fun OnTvTvShowDetailsScreen(
    movieId: String,
    navController: NavController,
    viewModel: OnTvDetailsViewModel = hiltViewModel(),
) {
    viewModel.getTvShowDetails(movieID = movieId.toInt())
    val tvShowDetail by viewModel.selectedMovie.collectAsState()
        ...
        toolbar = {
            ...
            Image(
                painter = rememberImagePainter(
                    data = Constants.POSTER_URL + tvShowDetail?.poster_path, builder = {
                        crossfade(true)
                        scale(Scale.FIT)
                    }),
